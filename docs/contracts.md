...
Prompt 5.1（logline 推荐）与 Prompt 5.2（反向追问）的硬规则见 `Onboarding向导原型设计 v0.1.md` §5.1 / §5.2，本文档不重复（变化频率较低）。
...
3. 同步更新 `README.md` §5、`MVP任务规划表.md` §五、`Implementation Breakdown.md` 对应 Step
